...
__ALIGN_BEGIN static uint8_t USBD_AUDIO_CfgDesc[USB_AUDIO_CONFIG_DESC_SIZ] __ALIGN_END =
    {
        ...
        0x00, /* 1.00 */                 /* bcdADC */
        0x01,
        0x1E, /* [EDITED] wTotalLength = 30*/ // 0x27,                                 /* wTotalLength = 39*/
        0x00,
        0x01, /* bInCollection */
        0x01, /* baInterfaceNr */
        /* 09 byte*/

        /* MIC _USB Speaker_ Input Terminal Descriptor */
        ...
        0x09,                            /* bLength */
        AUDIO_INTERFACE_DESCRIPTOR_TYPE, /* bDescriptorType */
        AUDIO_CONTROL_OUTPUT_TERMINAL,   // AUDIO_CONTROL_FEATURE_UNIT,           /* bDescriptorSubtype */
        ...
        /* MIC _USB Speaker_ Audio Streaming Interface Descriptor */
        AUDIO_STREAMING_INTERFACE_DESC_SIZE, /* bLength */
        AUDIO_INTERFACE_DESCRIPTOR_TYPE,     /* bDescriptorType */
        AUDIO_STREAMING_GENERAL,             /* bDescriptorSubtype */
        0x02,                                // 0x01,                                 /* bTerminalLink */
        0x01,                                /* bDelay */
        ...
        MIC_PACKET_SZE(USBD_AUDIO_FREQ),   // AUDIO_PACKET_SZE(USBD_AUDIO_FREQ),    /* wMaxPacketSize in Bytes (Freq(Samples)*2(Stereo)*2(HalfWord)) */
